...
redirect_from: /download/archives/1-8-0/
title: Banshee 1.8.0
---
...
### Other Enhancements
  ...
  * _Developers:_ DBus API additions for showing various dialogs
  * _Developers:_ new Hyena.Downloader API for performing downloads and easy HTTP operations: HttpFileDownloader, HttpStringDownloader
