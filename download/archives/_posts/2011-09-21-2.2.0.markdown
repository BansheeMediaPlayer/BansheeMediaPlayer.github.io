...
redirect_from: /download/archives/2-2-0/
title: Banshee 2.2.0
---
...
<div class="release-shot"><img src="/images/shots/2.2.0/emusic-700.png" alt="Screenshot showing Banshee's new eMusic online store integration"></div>

#### New custom support for the Barnes & Noble Nook

Transfer music between your library and your Nook device, it just works !
